...
public class ChamadoResource {
    ...
    @PutMapping(value = "/{id}")
	public ResponseEntity<ChamadoDTO> chamadoUpdate(
        @PathVariable Integer id, @Valid @RequestBody ChamadoDTO objDTO) {
		Chamado newObj = chamadoService.chamadoUpdate(id, objDTO);
