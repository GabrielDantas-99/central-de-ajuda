...
public class DBService {
    ...
    public void instanciaDB() {
        ...
        Tecnico tec1 = new Tecnico(null, "Gabriel Dantas", "550.482.150-95", "gabriel@mail.com", encoder.encode("123"));
		tec1.addPerfil(Perfil.ADMIN);
		Tecnico tec2 = new Tecnico(null, "Richard Stallman", "903.347.070-56", "stalkerman@mail.com", encoder.encode("123"));
